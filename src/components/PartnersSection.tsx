...
const items = [
  {
    name: "ChichWaka",
    icon: "Server",
    content: "ChichWaka — это сервер ванила+ режим с элементами экономики и РП, созданный для контента на стримах и зрителей стримеров.\n\nНа нём есть много разных людей, государств и городов. Самый лучший рп-сервер по мнению Xazbik_.",
  },
  {
    name: "Xaz&Der1",
    icon: "Users",
        ...
        {active && (
          ...
          >
            <motion.div
              ...
              className="max-w-lg w-full rounded-2xl bg-[#141414] border border-[#2a2a2a] p-6 shadow-2xl"
